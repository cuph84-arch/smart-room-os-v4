...
/* =======================================================
   HERO TOGGLE CLEAN POWER ICON FINAL
======================================================= */

.ac-card .target-toggle,
.lamp-card .target-toggle,
.ac-card .badge,
.lamp-card .badge {
...
/* Hapus bentuk toggle lama */
.ac-card .target-toggle::before,
.lamp-card .target-toggle::before,
.ac-card .badge::before,
.lamp-card .badge::before {
  content: "⏻" !important;
...
/* ON */
.ac-card .target-toggle.on::before,
.lamp-card .target-toggle.on::before,
.ac-card .badge.on::before,
.lamp-card .badge.on::before {
  color: #2596be !important;
}

/* OFF */
.ac-card .target-toggle.off::before,
.lamp-card .target-toggle.off::before,
.ac-card .badge.off::before,
.lamp-card .badge.off::before {
